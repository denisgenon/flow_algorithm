...
TODO Il faut vraiment dire que entrySet c'est pour avoir un set d'entry, que get c'est pour get un element, set pour set un element, put pour put un element et remove pour remove un element?