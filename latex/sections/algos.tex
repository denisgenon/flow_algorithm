...
\captionof{figure}{The residual graph.}
\end{center}
...
\begin{figure}[!h]
\includegraphics[scale=0.4]{images/graph1a.png}\hfill
\includegraphics[scale=0.4]{images/graph2.png}
\caption{The graphs A and B.}
\end{figure}

\begin{center}
\includegraphics[scale=0.4]{images/residualgraph1.png}
\captionof{figure}{The residual graph C.}
\end{center}
